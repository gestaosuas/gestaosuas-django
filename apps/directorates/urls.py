...
urlpatterns = [
    ...
    path("planos/<uuid:pk>/objetivos/", WorkPlanObjectivesView.as_view(), name="plan-objectives"),
    ...
    path("visitas/<uuid:pk>/relatorio/<str:report_type>/reverter/", RevertReportView.as_view(), name="visit-report-revert"),

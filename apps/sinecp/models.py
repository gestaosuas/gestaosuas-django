...
class QualificacaoReport(models.Model):
    ...
    uditech_centro_concluintes = models.IntegerField(null=True, blank=True, default=0)
    ...
    uditech_centro_atendimentos = models.IntegerField(null=True, blank=True, default=0)
